...
- Souped up regular enemies
	- May be considered *"Minibosses"*
- *Maximum* phases: **2**
- Induces **Reform** death
- Grants reward(s) from **Common** to **Rare**.
- All **Chief** bosses are optional, except [[Garnet]], who is a tutorial boss.
	- **Garnet** may be *moved* to **Anomaly** 

#### Anomaly
- Introduced with minor title card, and *minor* animation
	- Occasionally, with a cutscene
- *Minimum* phases: **2**
- *Maximum* phases: **3**
- Induces **Rewind** death
	- In some unique cases, an **Anomaly** *may* induce a **Reform** death instead.
- Grants reward(s) from **Rare** to **Legendary**
- Usually, **Anomalies** are optional, and not crucial to the [[main story]]
	- Defeating [[Aosi]] is a requirement for progressing past the [[Wailing Woods]]
	- Defeating [Lady Lazuli](Lady%20Lazuli.md) is a requirement for progressing past the [[Great Maylith Seal]]
- There are certain [[side stories]] that require battling **Anomalies** in specific ways
		...
		- Defeating [[Neketh]] for **Daughter of Eiare**
...
- Each **Vortex** is either a requirement, or directly related to, a specific *side story*
	- [Ashdyr](Ashdyr%20~%20Thousand-blade%20Sentinel.md) is a requirement for [Little Artificer](Act%20I%20~%20A%20Bitsy%20Request.md) 
	- [Alace](Alace%20Vansonia%20~%20Nightmare%20of%20Avalia.md) is a requirement for **Daughter of Eiare**
