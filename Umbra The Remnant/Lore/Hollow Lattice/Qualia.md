...
- Governs the ability for things to have arbitrary *positions* in an arbitrary number of *dimensions*.
	- Creates the **Spacetime Field**, a field that contains information about the *position* and *momentum* of all objects within a **Ripple**.
		- *Position* is stored as **Velocigen** information, and *momentum* as **Temporum** information. Thus, it is impossible to observe both at once, without possessing those two **Attunements**.
...
- It can be converted into from any type of **Qualia**, but cannot be converted back to anything.
